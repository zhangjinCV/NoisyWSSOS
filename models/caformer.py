...
def caformer_m36_384_in21ft1k(pretrained=False, **kwargs):
    model = MetaFormer(
        ...
        head_fn=MlpHead,
        **kwargs)
    model.load_state_dict(torch.load("/mnt/jixie16t/dataset/imagenet_pretrained_weight/CAFormer/caformer_m36_384_in21ft1k.pth"))
    return model
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("/mnt/jixie16t/dataset/imagenet_pretrained_weight/CAFormer/caformer_b36_384_in21ft1k.pth"))
