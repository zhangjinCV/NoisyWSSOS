...
def SwinB(pretrained=True):
    ...
    # model.load_state_dict(torch.load("/mnt/jixie16t/dataset/imagenet_pretrained_weight/Swin/swin_base_patch4_window12_384_22k.pth")['model'], strict=False)
    # if pretrained is True:
...
def SwinB_224():
    model = SwinTransformer(224, 4, 3, 128, [2, 2, 18, 2], [4, 8, 16, 32], window_size=7)
    model.load_state_dict(torch.load("/mnt/jixie16t/dataset/imagenet_pretrained_weight/Swin/swin_base_patch4_window7_224_22k.pth", map_location='cpu')['model'], strict=False)
    return model
