...
class FEDERNet(nn.Module):
    # resnet based encoder decoder
    def __init__(self, channels=96):
        super(FEDERNet, self).__init__()
        self.shared_encoder = timm.create_model(model_name="resnet50", pretrained=False, in_chans=3, features_only=True)
        self.shared_encoder.load_state_dict(torchvision.models.resnet50(True).state_dict(), strict=False)
    ...
    def forward(self, data):
        ...
        res = {'res': [pred_0, f4, f3, f2, f1, bound_f4, bound_f3, bound_f2, bound_f1]}
        return res
