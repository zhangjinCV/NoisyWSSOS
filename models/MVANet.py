...
class MVANet(nn.Module):  
    ...
    def forward(self, data):
        ...
        res = [sideout5, sideout4,sideout3,sideout2,sideout1,final_output, glb5, glb4, glb3, glb2, glb1,tokenattmap4, tokenattmap3,tokenattmap2,tokenattmap1]
        res = [F.interpolate(i, size=(1024, 1024), mode='nearest') for i in res]
        res = {'res': res}
        return res
