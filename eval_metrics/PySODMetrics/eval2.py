...
if __name__ == "__main__":
    ...
    pre_path = '/mnt/jixie16t/zj/zj/works_in_phd/NoisyCOS/results/DIS5K/PNet/100%'
    save_path = "/mnt/jixie16t/zj/zj/works_in_phd/NoisyCOS/score_records/DIS5K/PNet/100%"
